  ...
  <div class="community-view">
    <el-table :data="tableData" style="width: 100%;height: 80%;">
      ...
      <el-table-column label="操作">
        <template #header>
          <el-input v-model="search" size="small" placeholder="搜索仓库名" />
        </template>
        <template #default="scope">
          <el-link type="primary" size="small" @click="handleEdit(scope.$index, scope.row)"><el-icon><Link /></el-icon>github仓库</el-link>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
...
<style scoped lang="scss" src="./community.scss"></style>