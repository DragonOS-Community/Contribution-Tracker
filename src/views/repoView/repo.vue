<template>
  <div class="repo-view">
    ...
    <el-table :data="tableData" style="width: 100%;height: 80%;">
      ...
      <el-table-column prop="issue" label="ISSUE数量" sortable/>
      <el-table-column label="操作">
        <template #header>
          <el-input v-model="search" size="small" placeholder="请输入仓库名称" />
        </template>
        <template #default="scope">
          <el-link type="primary" size="small" @click="handleEdit(scope.$index, scope.row)">查看详情</el-link>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
...
<style scoped lang="scss" src="./repo.scss"></style>